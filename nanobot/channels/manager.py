...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        for name, cls in discover_all().items():
            ...
            try:
                kwargs: dict[str, Any] = {}
                # Voice channel keeps a direct_chat callback so callers can bridge
                # the bus into sync speech pipelines.
                if name == "voice":
                    kwargs["direct_chat"] = self.direct_chat
                ...
                channel_key = getattr(cls, "name", name)
