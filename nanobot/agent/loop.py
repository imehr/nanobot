...
if TYPE_CHECKING:
    from nanobot.config.schema import BrowserToolConfig, ChannelsConfig, ExecToolConfig, WebSearchConfig
    ...
    async def _process_message(
        ...
        if cmd == "/help":
            lines = [
                ...
                "/capture — Queue text or attachments into knowledge capture",
