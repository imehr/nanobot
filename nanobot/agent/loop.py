...
if TYPE_CHECKING:
    from nanobot.config.schema import BrowserToolConfig, ChannelsConfig, ExecToolConfig, WebSearchConfig, WebToolsConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from nanobot.config.schema import BrowserToolConfig, ExecToolConfig, WebSearchConfig, WebToolsConfig
